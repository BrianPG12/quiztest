(() => {
  ...
  var init_index_esm20175 = __esm({
    "node_modules/@firebase/firestore/dist/index.esm2017.js"() {
      ...
      F = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
      ...
      re = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
      DatabaseInfo = class {
        /**
      ...
      Pe = null;
      Ie = new Integer([4294967295, 4294967295], 0);
