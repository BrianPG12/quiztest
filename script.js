(() => {
  ...
  var init_common_fe7037b3_esm = __esm({
    "node_modules/@firebase/firestore/dist/common-fe7037b3.esm.js"() {
      ...
      b = "12.12.0";
      S = new Logger("@firebase/firestore");
      D = {
      ...
      Be = "documentOverlays";
      $e = "globals";
      Qe = [...[...[...[...[G, j, Y, $, ae, W, Ee, le], Ve], oe], Re], me, ge];
      Ge = [...Qe, Be];
      ze = [G, j, Y, ee, ae, W, Ee, le, Ve, oe, Re, me, ge, Be];
      je = ze;
      He = [...je, ye, De, Me];
      Ze = [...He, $e];
      ...
      Ye = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
      et = "server_timestamp";
      tt = "__type__";
      ...
      Tt = new SortedMap(DocumentKey.comparator);
      It = new SortedSet(DocumentKey.comparator);
      Et = new SortedSet(__PRIVATE_primitiveComparator);
      ...
      Vt = null;
      dt = new Integer([4294967295, 4294967295], 0);
...
Total Duration: ${a - u}ms`);
      ...
      __PRIVATE_WebChannelConnection = class ___PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
        constructor(e) {
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
      ...
      Yt = "ComponentProvider";
      en = /* @__PURE__ */ new Map();
      tn = "firestore.googleapis.com";
      nn = true;
      ...
      VectorValue = class _VectorValue {
        /**
         * @private
         * @internal
         */
  ...
  var init_index_esm7 = __esm({
    "node_modules/@firebase/firestore/dist/index.esm.js"() {
      init_index_esm4();
      init_index_esm2();
      init_common_fe7037b3_esm();
      init_common_fe7037b3_esm();
      init_index_esm();
      init_bloom_blob_es2018();
      init_index_esm3();
      init_webchannel_blob_es2018();
      Ut2 = "@firebase/firestore";
      Ht2 = "4.14.0";
