...
export const kanjiData = [
  ...
  makeKanjiEntry({ id: "kanji-sen", kanji: "千", meanings: ["thousand"], onyomi: ["sen"], kunyomi: ["chi"] }),
  makeKanjiEntry({ id: "kanji-man", kanji: "万", meanings: ["ten thousand"], onyomi: ["man"], kunyomi: ["yorozu"] }),
  makeKanjiEntry({ id: "kanji-en", kanji: "円", meanings: ["yen", "circle"], onyomi: ["en"], kunyomi: ["maru"] }),
  ...
  makeKanjiEntry({ id: "kanji-ko", kanji: "古", meanings: ["old"], onyomi: ["ko"], kunyomi: ["furui"] }),
  ...
  makeKanjiEntry({ id: "kanji-ko", kanji: "好", meanings: ["like", "prefer"], onyomi: ["ko"], kunyomi: ["suki", "konomi"] }),
  ...
  makeKanjiEntry({ id: "kanji-ko", kanji: "子", meanings: ["child"], onyomi: ["shi"], kunyomi: ["ko"] }),
  ...
  makeKanjiEntry({ id: "kanji-sen", kanji: "先", meanings: ["before", "ahead"], onyomi: ["sen"], kunyomi: ["saki"] }),
  ...
  makeKanjiEntry({ id: "kanji-ko", kanji: "公", meanings: ["public"], onyomi: ["ko"], kunyomi: [] }),
  makeKanjiEntry({ id: "kanji-en", kanji: "園", meanings: ["garden", "park"], onyomi: ["en"], kunyomi: ["sono"] }),
